...
double Helpers::mpersec_to_mph(double x) { return x * 3.6 / 1.60934; }
...
uint Helpers::ClosestWaypoint(double x, double y, const vector<double> &maps_x,
                              const vector<double> &maps_y) {
  double closestLen = 100000;  // large number
  uint closestWaypoint = 0;
...
uint Helpers::NextWaypoint(double x, double y, double theta,
                           const vector<double> &maps_x,
                           const vector<double> &maps_y) {
  uint closestWaypoint = ClosestWaypoint(x, y, maps_x, maps_y);
...
vector<double> Helpers::getFrenet(double x, double y, double theta,
                                  const vector<double> &maps_x,
                                  const vector<double> &maps_y) {
...
vector<double> Helpers::getXY(double s, double d, const vector<double> &maps_s,
                              const vector<double> &maps_x,
                              const vector<double> &maps_y) {
  int prev_wp = -1;
...
bool Helpers::read_map_data(std::string filename,
